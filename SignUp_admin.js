...
export default function SignUp_Admin({navigation}) {
...
const saveUser = async () => {
  if (!name || !email || !password) {
    ...
    try {
      ...
      await firestore()
        .collection('AdminData') // Replace with your Firestore collection name
  ...
  return (
    ...
    <TouchableHighlight style={[styles.signUpText]} onPress={() => navigation.navigate("signin_admin")}>
      <Text style={styles.signUpText}>Already Have an Account? Login as Admin</Text>
    </TouchableHighlight>
    </>
    }
    </ImageBackground>
