...
export default function SignUp_Teacher({navigation}) {
    ...
    const saveUser = async () => {
      if (!name || !email || !password) {
        ...
        try {
          ...
          await firestore()
            .collection('TeachersData') // Replace with your Firestore collection name
          ...
          console.log("passed");
          navigation.navigate("teacher_dash")
          setLoading(false);
          setName("");
          setEmail("");
          setPassword("");
  ...
  return (
    ...
    <TouchableHighlight style={[styles.signUpText]} onPress={() => navigation.navigate("signin_teacher")}>
      <Text style={styles.signUpText}>Already Have an Account? Login as Teacher</Text>
    </TouchableHighlight>
    </>
    }
    </ImageBackground>
