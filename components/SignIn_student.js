...
export default function SignIn_Student({navigation}) {
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        <TouchableHighlight style={[styles.signUpText]} onPress={() => navigation.navigate("signup_student")}>
          <Text style={styles.signUpText}>Don't Have an Account? Register as Student</Text>
        </TouchableHighlight>
        </>
        }
        </ImageBackground>
